...
class _ShareSheet extends StatelessWidget {
  ...
  Widget buildShare(BuildContext context) {
    ...
    if (shareSheet.wrap!) {
      row = optionsLength % shareSheet.wrapNumber == 0
            ...
            children: List.generate(row, (index) {
              ...
              return SingleChildScrollView(
                  ...
                  child: Container(
                    ...
                    padding: index != row - 1
                        ? const EdgeInsets.only(bottom: Style.shareSheetPadding)
                        : const EdgeInsets.only(top: Style.shareSheetPadding),
              ...
              child: Column(
                children: [
                  Container(
                    ...
                    margin: const EdgeInsets.only(bottom: Style.intervalLg),
                    child: item.icon ??
                        const Icon(
                          Icons.share,
        ...
        child: SafeArea(
          ...
          children: [
            (shareSheet.title != null || shareSheet.description != null)
                ...
                : Container(),
            Container(
              padding: const EdgeInsets.all(Style.shareSheetPadding),
